...
For a branch such as `translation/v1.29.1`, download assets from the matching
release tag:
...
- `dsw-science-europe-zh-hant-v1.29.1.zip`: DSW import package
- `test-project-v1.29.1.pdf`: demo render
- `test-project-v1.29.1.pdf.json`: render metadata
